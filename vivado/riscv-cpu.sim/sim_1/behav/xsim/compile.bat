...
REM
REM Generated by Vivado on Wed Jan 14 12:32:25 -0600 2026
...
echo "xvlog --incr --relax -L uvm -prj hazard_unit_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj hazard_unit_tb_vlog.prj -log xvlog.log
